...
class UpdateProductScreen extends StatefulWidget {
  Category cat;
  Product product;
  UpdateProductScreen(this.product, this.cat);
  @override
  State<UpdateProductScreen> createState() => _UpdateProductScreentState();
}

class _UpdateProductScreentState extends State<UpdateProductScreen> {
  @override
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        onPressed: ()  {
                         Provider.of<FireStoreProvider>(context, listen: false)
                              .updateProduct(widget.product, widget.cat);
                        },
                        style: ButtonStyle(
                            backgroundColor:
